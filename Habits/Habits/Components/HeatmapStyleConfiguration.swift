...
struct HeatmapStyleConfiguration {
    ...
    static let premiumDefault = HeatmapStyleConfiguration(
        ...
        inactiveStrokeOpacity: 0.044,
        inactiveStrokeColor: Color(red: 0.63, green: 0.70, blue: 0.79),
        inactiveFillOpacity: 0.025,
        intensityScale: [0.0, 0.15, 0.28, 0.43, 0.60],
        activeBorderOpacityByLevel: [0.0, 0.07, 0.085, 0.10, 0.115],
        selectedStrokeOpacity: 0.46,
